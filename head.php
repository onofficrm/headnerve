...
// site_config 브랜드 색 → :root (hex만 허용) — add_stylesheet 전에 초기화
$g5_css_brand = '';
...
<div id="wrapper">
    ...
    <div id="container">
        <?php
        $headnerve_skip_container_title = function_exists('headnerve_is_g5b_board') && headnerve_is_g5b_board();
        if (!defined('_INDEX_') && !$headnerve_skip_container_title) {
