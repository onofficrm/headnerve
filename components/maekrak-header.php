...
$maekrak_phone = function_exists('g5site_cfg') ? g5site_cfg('phone', '02-6959-7252') : '02-6959-7252';
...
$maekrak_logo_url = isset($g5_logo_url) ? $g5_logo_url : '';
?>
...
<div id="hd">
    <header id="siteHeader" class="maekrak-header site-header is-scrolled">
        ...
        <div class="maekrak-header__inner">
            <div class="maekrak-header__logo">
                <a href="<?php echo G5_URL; ?>" class="maekrak-header__logo-link">
                    <?php if ($maekrak_logo_url) { ?>
                    <img src="<?php echo $maekrak_logo_url; ?>" alt="<?php echo get_text($maekrak_site_title); ?>" class="maekrak-header__logo-img">
                    <?php } else { ?>
            ...
            <div class="maekrak-header__right">
                ...
                <div class="maekrak-header__actions">
                    <?php if ($is_member) { ?>
                    <a href="<?php echo G5_BBS_URL; ?>/logout.php" class="maekrak-header__btn maekrak-header__btn--ghost">로그아웃</a>
                    <?php if ($is_admin) { ?>
                    <a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" class="maekrak-header__btn maekrak-header__btn--ghost">관리자</a>
                    <?php } ?>
                    <?php } else { ?>
