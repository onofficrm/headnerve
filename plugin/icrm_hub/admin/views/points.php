...
<div class="icrm-pts-grid">
    ...
    <div class="icrm-pts-card">
        <strong>포인트 잔액</strong>
        <span><?php echo number_format($balance); ?>P</span>
    </div>
    <div class="icrm-pts-card">
        <strong>AI 사용 기록</strong>
...
<p class="icrm-pts-hint" style="margin:-6px 0 16px">
    AI SEO·순위체크·콘텐츠 수집 사용 시 <strong>로그인한 회원</strong>의 그누보드 포인트가 차감됩니다.
    상단 잔액은 차감 반영 후 현재 보유 포인트이며, 사용 내역의 잔액은 해당 시점 기록입니다.
    iCRM 충전·동기화는 포인트가 0일 때 또는 수동 동기화 시에만 반영됩니다.
    <?php if ($mb_id !== '') { ?>
...
<section class="icrm-pts-panel">
    <h2>AI 포인트 사용 내역</h2>
    <p class="icrm-pts-hint">SEO 메타 · 순위체크 · 콘텐츠 수집 등 iCRM AI API 호출 기록입니다. (회원 <code><?php echo icrm_pts_h($mb_id); ?></code>)</p>
