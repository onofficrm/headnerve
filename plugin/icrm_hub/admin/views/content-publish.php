...
<div class="icc-module icp-compose">
    ...
    <form id="icp_compose_form" class="icp-compose__layout" autocomplete="off">
        <input type="hidden" name="ici_id" id="icp_ici_id" value="0">
        ...
        <aside class="icp-compose__aside">
            <section class="icp-compose__panel">
                ...
                <div class="icp-field">
                    ...
                    <input type="text" class="icp-input" id="icp_topic" name="topic" placeholder="예: 두통 원인과 예방법" required>
                </div>

                <div class="icp-field">
                    <label class="icp-label" for="icp_keywords">추가 키워드</label>
                    <input type="text" class="icp-input" id="icp_keywords" name="keywords" placeholder="두통, 편두통, 스트레스">
