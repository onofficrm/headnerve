...
function maekrak_conditions_data()
{
    ...
    return array(
        'headache' => array(
            ...
            'faq' => array(
                array(
                    'q' => '한의원에서도 두통 검사와 치료를 받을 수 있나요?',
                    'a' => '증상 패턴, 자율신경 상태, 두개경추 구조를 함께 확인한 뒤 한약·약침·추나 등 맥락한의원 치료 프로그램을 검토할 수 있습니다.',
                ),
                array(
                    'q' => '신경과 검사가 정상인데도 두통이 계속되면 어떻게 봐야 하나요?',
                    'a' => '구조적 이상이 MRI에서 보이지 않더라도 기능적 불균형—경추 긴장, 자율신경, 뇌 에너지 공급 문제로 증상이 이어질 수 있어 함께 평가합니다.',
                ),
                array(
                    'q' => '편두통·긴장형두통·경추성두통을 한 곳에서 보나요?',
                    'a' => '두통 진료과목 페이지에서 개요를 안내하고, 편두통·군발두통·경추성두통 등은 하위 질환 상세 페이지에서 각각 설명합니다.',
                ),
                array(
                    'q' => '진통제를 줄이면서 치료할 수 있나요?',
                    'a' => '약물 과용두통 등 패턴에 따라 단계적으로 조절 방향을 논의합니다. 개인별 경과에 따라 계획이 달라질 수 있습니다.',
                ),
            ),
            'blog_category' => '두통',
        ),
        'dizziness' => array(
            ...
            'faq' => array(
                array(
                    'q' => '이비인후과 검사가 정상인데 어지럼증이 남아도 한의원 진료가 가능한가요?',
                    'a' => '비회전성 어지럼·경추 연관 증상은 귀 이외 요인이 있을 수 있어 경추·자율신경 관점의 평가가 필요할 수 있습니다.',
                ),
                array(
                    'q' => '메니에르·이석증과 경추성 어지럼을 어떻게 구분하나요?',
                    'a' => '회전성·자세 유발 패턴, 목 움직임과의 연관, 동반 두통 등을 함께 확인합니다. 필요 시 전문의 협진을 권합니다.',
                ),
                array(
                    'q' => '어지럼과 두통이 함께 있으면 어디부터 봐야 하나요?',
                    'a' => '두 증상이 동시에 반복되면 신경계 전반—경추, 자율신경, 뇌 에너지 균형을 함께 보는 것이 일반적입니다.',
                ),
            ),
            'blog_category' => '어지럼증',
        ),
        'autonomic' => array(
            ...
            'faq' => array(
                array(
                    ...
                    'a' => '기능 검사에서 이상이 없어도 자율신경 조절 문제로 증상이 이어질 수 있어, 생활 리듬·경추·흉추 긴장을 함께 확인합니다.',
                ),
                array(
                    'q' => '자율신경실조증과 공황·불안 증상을 같이 봐야 하나요?',
                    'a' => '증상이 겹치는 경우가 많아 상위 진료과목에서 개요를 보고, 공황·불안·불면 등은 하위 질환 페이지에서 상세히 안내합니다.',
                ),
                array(
                    'q' => '약만으로 증상을 막는 것과 한의원 치료의 차이는 무엇인가요?',
                    'a' => '맥락한의원은 증상 억제뿐 아니라 교감·부교감 균형과 수면·호흡·구조적 부담을 함께 줄이는 방향을 목표로 합니다.',
                ),
                array(
                    'q' => '불면과 소화장애도 같은 진료과목에서 보나요?',
                    'a' => '자율신경과 연관된 불면·소화 증상은 같은 맥락에서 평가하며, 필요 시 불면 등 하위 페이지를 참고할 수 있습니다.',
                ),
            ),
            'blog_category' => '자율신경',
        ),
        'peripheral' => array(
            ...
            'faq' => array(
                array(
                    'q' => '손발 저림·작열감이 3개월 이상이면 한의원에서도 치료가 가능한가요?',
                    'a' => '말초 혈류·신경 영양·포착 요인을 함께 보는 통맥탕·약침·침 치료 방향을 검토할 수 있습니다.',
                ),
                array(
                    'q' => '당뇨·항암 치료 후 말초신경 증상도 같은 진료과목인가요?',
                    'a' => '당뇨성·CIPN 등은 하위 질환 페이지에서 구체적으로 안내하며, 혈당·항암 이력은 함께 확인합니다.',
                ),
                array(
                    'q' => '허리디스크 치료 후에도 발 증상이 남으면 왜 그런가요?',
                    'a' => '요추 문제와 별도로 말초 신경 통로·골반·하지 구조에서 포착이 이어질 수 있어 함께 살핍니다.',
                ),
            ),
            'blog_category' => '말초신경',
        ),
        'brainfog' => array(
            ...
            'faq' => array(
                array(
                    ...
                    'a' => '머리 멍함·집중 저하는 뇌 혈류·에너지 대사·수면 회복·경추 구조 등 기능적 요인과 연관될 수 있습니다.',
                ),
                array(
                    'q' => '코로나 이후 머리 멍함이 남아도 진료가 가능한가요?',
                    'a' => '장기코로나 후 브레인포그 등 하위 질환 페이지에서 후유증 관점의 안내를 제공합니다.',
                ),
                array(
                    'q' => '커피에 의존하는데 한의원 치료와 병행할 수 있나요?',
                    'a' => '카페인 패턴과 수면·에너지 리듬을 함께 확인하며, 단계적으로 조절 방향을 논의할 수 있습니다.',
                ),
                array(
                    'q' => '만성피로와 함께 집중이 안 될 때 무엇을 먼저 보나요?',
                    'a' => '수면 질, 자율신경, 두개경추, 뇌 에너지 공급을 순서 없이 교차 확인하는 평가가 일반적입니다.',
                ),
            ),
            'blog_category' => '브레인포그',
        ),
